 ...
 */
public class RollingUpgradeRule extends UpgradeTestRule {

  public RollingUpgradeRule() {
    super("camunda.cfg.xml");
  }

  public RollingUpgradeRule(String configurationResource) {
  ...
  private class TaggedStatement extends Statement {
    ...
    public void evaluate() throws Throwable {
      for (String tag : tags) {
        RollingUpgradeRule.this.setTag(tag);
        RollingUpgradeRule.super.apply(statement, description).evaluate();
//        statement.evaluate();
      }
    }
  }
